setTimeout(() => {
    ...
    alert("Hey Devs are you ready to test mood swing");
    var name = prompt("Please enter your name DEVS");
    let display = document.getElementsByClassName(".display");

    document.querySelector('.display').innerHTML = `Welcome to the project ${name}.`;
